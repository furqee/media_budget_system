...
class AdplatformsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'adplatforms';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Adplatforms();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'adplatforms',
	...
	public static function display(  )
	{
		...
		$model  = new Adplatforms();
		$info = $model::makeInfo('adplatforms');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('adplatforms.public.view',$data);			
			}			
		} 
		else {
			...
			return view('adplatforms.public.index',$data);	
		}
